	...
	if x == "8" :
		...
		for budget in list :
			if budget.category == category :
				flag = False
				if budget.withdraw(amount) == amount :
					print (f"You have withdrawn {amount} from {category} successfully")
				else :
		...
		for budget in list :
			if budget.category == category :
				flag=False
				if budget.deposit(amount) == amount :
					print (f"You have deposited {amount} into {category} successfully")
